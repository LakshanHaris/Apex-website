<%-- 
    Document   : admViewStudent
    Created on : Oct 20, 2017, 4:30:08 PM
...
<html>
    ...
    <br><br>
    <label id="stu-reg-main-title">Search a Student</label>
    <hr id="stu-reg-divider">
     ...
     <div class="panel-body">
        <div class="row">
         ...
         <form action="../student/admViewStudentLoaded" method="GET">
        <div class="row">

            <div class="col-lg-4">
                <input class="form-control" placeholder="registration number" name="stuRegNumber">
