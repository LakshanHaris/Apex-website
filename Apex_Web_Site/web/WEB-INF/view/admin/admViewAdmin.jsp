<%-- 
    Document   : ViewAdmin
    Created on : Oct 19, 2017, 8:01:57 PM
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <br><br><br>
                <label id="stu-reg-main-title">Profile</label>
                ...
                <div class="content-wrapper" id="custom-student-background">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <img src="../resources/img/img2.jpg" width="200" height="200" id="admin-Pic">
                            ...
                            <div class="box-body">
                                <table class="table table-striped ">
                                    ...
                                    <tr>
                                        ...
                                        <td>Admin Registration Number</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>${adminResult.firstName}</td>
                                    </tr>
                                    
                                    <tr>
                                        <td>Admin last name</td>
                                        <td>${adminResult.lastName}</td>
                                    </tr>
                            ...
                            <form action="../admin/admUpdateAdmin" method="GET">
                            
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-success btn-success">Edit Profile</button>
                            </div>
                            ...
                            <form action="../admin/admAddAdmin" method="GET">
                            
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-success btn-success">Add new Admin</button>
                            </div>
                            ...
                            <form action="../admin/admDeleteAdmin" method="GET">
                            
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-success btn-success">Delete a Admin</button>
                            </div>
                            ...
                            <label id="stu-reg-main-title">View Your Payment Progress</label>
                            <hr id="stu-reg-divider">

                            <div class="col-lg-10 col-md-10">
                                <br><br><br><br>
                                <label>Click here to proceed !</label>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="admin-view-adm-payments.html"><button type="button" class="btn  btn-success">Payments</button></a>
