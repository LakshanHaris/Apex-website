<%-- 
    Document   : admScanStudentAttendence.
    Created on : Oct 21, 2017, 10:18:42 AM
...
<div id="page-wrapper">
    ...
    <br><br>
    <label id="stu-reg-main-title">Scan Students Attendence</label>
    <hr id="stu-reg-divider">
     ...
     <div class="panel-body">
        ...
        <div class="row">
            ...
            <input class="form-control" placeholder="admin registration number" id="adminRegIdScanAttendance" >
            ...
            <input class="form-control"  type="password" placeholder="admin password" id="adminPasswordScanAttendance">
       ...
       <div id="viewAttendenceValidate">
        ...
        <div class="row">
            ...
            <br>               
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="admin-scan-attendence-fast.html"><button type="submit" class="btn btn-primary" id="admin-scan-btn-msg">&nbsp;Scan fast</button></a>
        ...
        <div id="scanAttendenceResultsView">

        <br><br><br><p>Absenties of the last in close 4 days are searched and listed below : &nbsp;&nbsp;<u>07</u> results were found.</p>
        ...
        <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="panel panel-info">
                        ...
                        <p>You can send an e-mail or a text message to appropriate parents of the identified students informing about the poor attendence</p> .<p>&nbsp;&nbsp;To proceed follow this links --> </p>
