<%-- 
    Document   : stuViewPayHistory
    Created on : 06-May-2018, 23:39:21
        ...
        <div class="container" id="mainContainer">
            ...
            <form id="stuViewPayForm">
                <div class="row">
                    ...
                    <div class="col-md-1"></div>
                    <div class="col-md-2">
                        <button type="button" class="btn btn-success" id="searchBtn-payHistory">Search</button>
                    </div>
                </div>
            </form>
