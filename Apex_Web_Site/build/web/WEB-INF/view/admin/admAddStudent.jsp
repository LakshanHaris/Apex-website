    ...
    <body class="skin-blue">
        ...
        <div class="wrapper">
            <header class="main-header">
                <a href="#" class="logo"><b>Apex</b>Institution</a>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div id="page-inner">
                        <div id="page-wrapper">
                            <br><br>
                            <label style="font-size: 30px;  margin-left: 350px;">Register New Student</label>
                            <br><br>
                            <label style="font-size: 20px;  margin-left: 180px;">First enter Parent's details</label>


                            <div class="panel-body">
                                <form id="admAddParentForm">
                                    <div class="row">
                                        <div class="col-lg-2">
                                        </div>
                                        <div class="col-lg-7">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <div class="col-lg-4">
                                                <button type="button" class="btn btn-primary" id="admAddParentBtn">Register Student</button>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                        </div>
                                ...
                                <form id="admAddStudentForm">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="parent id" name="parentId">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <hr id="stu-reg-divider">
                                            <div class="col-lg-4">
                                                <button type="button" class="btn btn-primary" id="admAddStuBtn">Register Student</button>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                        </div>
