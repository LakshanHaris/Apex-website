<%-- 
    ...
    Created on : Oct 20, 2017, 4:16:29 AM
                    ...
                    <div class="col-md-8" id="stu-edit-profile">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="${adminResult.firstName}" name="firstName" >
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="${adminResult.lastName}" name="lastName">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="${adminResult.dob}" id = "datepicker-5" name="dob">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        <label>Address :</label>
                                        <input class="form-control" placeholder="${adminResult.address}" name="address">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="${adminResult.mobileNumber}" name="mobileNumber">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        <label>Email :</label>
                                        <input class="form-control" placeholder="${adminResult.email}" name="email">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        <label>Bank :</label>
                                        <input class="form-control" placeholder="${adminResult.bank}" name="bank">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="${adminResult.branch}" name="branch">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="${adminResult.bankAcc}" name="bankAcc">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="password" placeholder="${adminResult.password}" name="password">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="col-lg-4">
                                    <button type="button" class="btn btn-primary" id="admUpdateAdminBtn">Submit details</button>
                                </div>
                            </div>
