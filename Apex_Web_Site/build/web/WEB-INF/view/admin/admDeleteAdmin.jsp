<%-- 
    ...
    Created on : Oct 20, 2017, 3:27:25 AM
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container" id="welcomeDetails">
                    ...
                    <br><br><br>
                    <p><h3><strong><u>Delete a existing Admin here</u></strong></h3></p> 
                    <div class="row">
                        <div class="col-md-6" >

                            <label> <strong>Welcome Admin</strong></label>
                            <label>Please enter Admin Id here ....</label>
                    ...
                    <div class="col-md-8" id="stu-edit-profile">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="admin_id" id="admRegNumber" name="admRegNumber">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="col-lg-4">
                                    <button type="button" class="btn btn-primary" id="admDeleteBtn">Delete</button>
                                </div>
                            </div>
