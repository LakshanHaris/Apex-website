            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div id="page-inner">
                        ...
                        <br><br>
                        <label style="font-size: 30px;  margin-left: 320px;">Delete a Admin</label>
                        <br><br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="admin_id" name="admRegNumber" type="number" id="admRegNumber">
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                    </div>
