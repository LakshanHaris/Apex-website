<%-- 
    Document   : admDeleteStaff
    Created on : Oct 20, 2017, 1:48:18 PM
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <br><br>
                <label id="stu-reg-main-title">Delete a Staff Member</label>
                ...
                <div class="panel-body">
                    ...
                    <form id="admDelStfForm">
                        <div class="row">

                            <div class="col-lg-4">
                                <input class="form-control" placeholder="registration number" id="delStfId" name="stfRegNumber">
                        ...
                        <!--                    <div id="loadingDivDelStaffMember">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading">
                                                                <label>"Deleting a staff member is a great loss to the institutuion. &nbsp;If you still wish to delete please explain the reason and delete"</label>
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <select class="form-control">
                                                                                                        <option>It's a request from the member</option>
                        ...
                        <div class="col-lg-6">
                            ...
                            <button type="button" class="btn btn-primary" id="admDelStfBtn">Delete</button>
