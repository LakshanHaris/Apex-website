<%-- 
    Document   : admViewTutor
    Created on : Oct 20, 2017, 7:25:11 AM
...
<div id="page-wrapper">
    ...
    <br><br>
    <label id="stu-reg-main-title">Search a Tuitor</label>
    ...
    <div class="panel-body">
        ...
        <form action="../tutor/admViewTutorLoaded" method="GET">
        <div class="row">

            <div class="col-lg-4">
                <input class="form-control" placeholder="registration number" name="tuiRegNumber">
