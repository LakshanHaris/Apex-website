                ...
                <div class="col-md-6">
                    <form id="tuiEditTutorForm">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-form-label" for="inputDefault">Graduation</label>
                                <input type="text" class="form-control" placeholder="graduation"  name="graduation">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" for="inputDefault">Stream</label>
                                <input type="text" class="form-control" placeholder="stream"  name="tutor_stream">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-form-label" for="inputDefault">Bank</label>
                                <input type="text" class="form-control" placeholder="bank"  name="bank">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" for="inputDefault">Bank branch</label>
                                <input type="text" class="form-control" placeholder="branch"  name="branch">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label" for="inputDefault">Bank Acc.</label>
                                <input type="text" class="form-control" placeholder="bank acc."  name="bankAcc">
                            </div>
                            <div class="form-group">
                            ...
                            <br>
                            <br>
                            <button type="button" class="btn btn-primary" id="tuiEditTutorBtn">Submit</button>
                        </fieldset>  
                    </form>
